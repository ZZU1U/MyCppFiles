...
/*
 * This is a hashing code template - struct and operators
 * And solution for finding a palindrome in string
 *
 * P.S. i've not finished it, it doesn't work for palindromes with even length
 *
 */
